...
import GridWithStars2 from "../components/grid-with-stars2";
import GridWithStars from "../components/grid-with-stars";
import GridWithStars1 from "../components/grid-with-stars1";
  ...
  return (
    <div className={styles.jobPreviewDashboard}>
      ...
      <main className={styles.gridWithStarsParent}>
        <div className={styles.gridWithStars}>
          <Grid />
        </div>
        <GridWithStars2 />
        <GridWithStars />
        ...
        <section className={styles.jobDetails}>
          <div className={styles.jobDetails1}>
            <div className={styles.jobDetailsChild} />
            <div className={styles.actionDividerParent}>
            ...
            <div className={styles.jobDescription}>
              ...
              >{`1. Handle the UI/UX research design 2. Work on researching on latest web applications designs & trends 3. Work on conceptualizing and visualizing 4. Work on creating graphics content and other graphic related works`}</p>
